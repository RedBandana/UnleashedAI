...
export const fetchChatsPageReceived = (state) => state.chats.chatsPageReceived;
...
export const createChatValue = (state) => state.chats.createChatReceived;
...
export const deleteChatValue = (state) => state.chats.deleteChatReceived;
